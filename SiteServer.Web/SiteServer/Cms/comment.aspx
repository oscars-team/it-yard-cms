<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Cms.Comment" %>
    ...
    <script type="text/javascript">
        ...
        function deleteComments() {
            if (confirm('确定要删除这些评论吗？')) {
                $.get('/SiteServer/Cms/pageCommentHandler.ashx?action=delete&ids=' + _getCheckBoxCollectionValue(document.getElementsByName('IDsCollection')), function (e) {
                    if (e == "ok") {
        ...
        function auditComments() {
            if (confirm('确定要审核通过吗？')) {
                $.get('/SiteServer/Cms/pageCommentHandler.ashx?action=audit&ids=' + _getCheckBoxCollectionValue(document.getElementsByName('IDsCollection')), function (e) {
                    if (e == "ok") {
                        location.href = location.href;
                    } else {
                        alert(e);
    ...
    <form class="m-l-15 m-r-15" runat="server">
        ...
        <div class="card-box">
                        ...
                        <table id="contents" class="table tablesaw table-hover m-0">
                            <thead>
                                <tr class="thead">
                                    ...
                                    <th class="text-center text-nowrap" width="100">时间</th>
                                    <th class="text-center text-nowrap" width="100"></th>
          ...
          <asp:PlaceHolder id="PhTrash" runat="server" visible="false">
            ...
            <input type="button" class="btn m-r-5" id="BtnDelete" value="删 除" onclick="deleteComments()" />
            <input type="button" class="btn m-r-5" id="BtnAudit" value="审核" onclick="auditComments()"/>
        </div>
