    ...
    <div class="card-box">
      <div class="form-group">
        <label class="col-form-label">附件上传文件夹
          <asp:RequiredFieldValidator ControlToValidate="TbFileUploadDirectoryName" errorMessage=" *" foreColor="red"
            display="Dynamic" runat="server" />
          <asp:RegularExpressionValidator runat="server" ControlToValidate="TbFileUploadDirectoryName"
      ...
      <div class="form-group">
        <label class="col-form-label">上传附件最大大小
          <asp:RequiredFieldValidator ControlToValidate="TbFileUploadTypeMaxSize" errorMessage=" *" foreColor="red"
            display="Dynamic" runat="server" />
          <asp:RegularExpressionValidator ControlToValidate="TbFileUploadTypeMaxSize" ValidationExpression="\d+"
            Display="Dynamic" ErrorMessage="上传附件最大大小必须为整数" foreColor="red" runat="server" />
        </label>
        <div class="row">
          <div class="col">
