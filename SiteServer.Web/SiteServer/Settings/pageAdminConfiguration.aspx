...
<%--        <li class="nav-item">
    ...
    <div class="card-box">
      ...
      <div class="form-group">
        ...
        <asp:RadioButtonList ID="RblIsLoginFailToLock" OnSelectedIndexChanged="RblIsLoginFailToLock_SelectedIndexChanged"
      ...
      <asp:PlaceHolder ID="PhFailToLock" runat="server">
        <div class="form-group">
          <label class="col-form-label">登录失败次数锁定（次）
            <asp:RequiredFieldValidator ControlToValidate="TbLoginFailToLockCount" runat="server" ErrorMessage="*"
        ...
        <div class="form-group">
          ...
          <asp:DropDownList ID="DdlLoginLockingType" OnSelectedIndexChanged="DdlLoginLockingType_SelectedIndexChanged"
            class="form-control" runat="server" AutoPostBack="true"></asp:DropDownList>
        </div>
        ...
        <asp:PlaceHolder ID="PhLoginLockingHours" runat="server">
          <div class="form-group">
            <label class="col-form-label">管理员锁定时间（小时）
              <asp:RequiredFieldValidator ControlToValidate="TbLoginLockingHours" runat="server" ErrorMessage="*"
                foreColor="Red"></asp:RequiredFieldValidator>
            </label>
